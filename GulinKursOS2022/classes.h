...
public:
	...
	void add(int id_input, string name_input, string owner_name_input) //создать процесс (состояние процесса – «порождение», очередь заданий пустая, кол-во заданий равно нулю)
	{
